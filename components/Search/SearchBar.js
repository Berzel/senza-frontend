        ...
        <SearchBarStyles>
            <form action="/search" className="form">
                <div className="group query">
                    ...
                    <input className="query" name="q" value={query} onChange={e => setQuery(e.target.value)} type="text" placeholder="Job title or keyword..." />
                </div>
                <div className="group location">
                    ...
                    <input className="location" name="location" value={location} onChange={e => setLocation(e.target.value)} type="text" placeholder="Location" />
                </div>
