...
const options = [
  ...
  { title: 'Saved Alerts', href: '/saved-alerts' },
              ...
              <ul className="items">
                ...
                {options.map(({ title, href }) => (
                  ...
                  >
                    ...
                    <Link href={href}>
                      <a className="menu_item_link">{title}</a>
                    </Link>
                    {title === 'Post a job' && <Divider sx={{ my: 0.5 }} />}
                  </Box>
                ))}
