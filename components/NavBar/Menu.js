...
const MenuStyles = styled.div`
    ...
    ._user_btn {
        ...
        .menu_wrapper {
            ${tw`absolute right-0 pt-2 hidden`}
            ...
            > .items {
                min-width: 12rem;
                ${tw`whitespace-nowrap bg-white shadow-lg p-3 rounded space-y-2`}
            ...
            <div className='_user_btn'>
                {
                    open ? (
                        ...
                        user ? (
                            // Show the user icon
                            <svg style={{transform: 'scale(1.3)'}} viewBox="0 0 24 24" onClick={e => setOpen(!open)}>
